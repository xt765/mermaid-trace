...
def test_sync_endpoint(caplog: Any):
    caplog.clear()
...
def test_async_endpoint(caplog: Any):
    caplog.clear()
...
def test_nested_tracing(caplog: Any):
    ...
    resp_inner = records[2].flow_event
    resp_mid = records[3].flow_event
...
def test_query_params_logging(caplog: Any):
    caplog.clear()
...
def test_trace_id_header(caplog: Any):
    caplog.clear()
    tid = "custom-trace-1"
...
def test_fastapi_error(caplog: Any):
    caplog.clear()
...
def test_fastapi_file_output(tmp_path):
